package seminar4.ClientApplication;

import seminar4.Core.Customer;
import seminar4.Interfaces.ICustomer;
 ...
 */
public class Start extends seminar4.ClientApplication.EnterData {
    ...
    private void login() {
        ...
        try {
            customer.setUser(seminar4.ClientApplication.Authentication.authentication(customer.getUserProvider(), userName, passwordHash));
        } catch (RuntimeException ex) {
