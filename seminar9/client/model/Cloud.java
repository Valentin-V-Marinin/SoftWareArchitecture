...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2023-08-08T01:50:44.955733679Z[GMT]")
...
public class Cloud {
   ...
   * @return cloudId
  **/
  @Schema(example = "f1o2b615", description = "")
  ...
  **/
   ...
   * @return RAM
  **/
  @Schema(example = "128", required = true, description = "Объём оперативной памяти")
  ...
  **/
   ...
   * @return HDD
  **/
  @Schema(example = "512", required = true, description = "Объём жесткого диска Гб")
